...
public class OI {
    ...
    public static JoystickButton b103 = new JoystickButton(buttonboard1, 3);
    public static JoystickButton b104 = new JoystickButton(buttonboard1,4);
    ...
    private OI() {
        leftBumper.whenPressed(new MoveArmCommand());
